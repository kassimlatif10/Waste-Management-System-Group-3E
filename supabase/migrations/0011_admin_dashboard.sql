-- Phase 3: admin dashboard aggregation, porting admin_views.py's
-- DashboardView (:123). Most other admin actions (approve/suspend
-- collectors, KYC review, branch/report/ticket CRUD, collector assignment)
-- don't need new RPCs — the is_admin() RLS policies from Phase 0 already
-- grant admin full read/write on those tables directly.
